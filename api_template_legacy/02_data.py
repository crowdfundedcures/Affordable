...
# curl -X POST "https://soma.science/api/v1/login" -H  "accept: application/json" -H  "Content-Type: application/x-www-form-urlencoded" -d "username=______________%40gmail.com&password=________"
...
path_and_filename_i = "./metadata/perturbagens_o.txt"
path_o = "./data/"
